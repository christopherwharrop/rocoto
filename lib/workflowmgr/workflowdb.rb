  ...
  class WorkflowSQLite3DB
    ...
    def lock_workflow
      ...
      begin
        ...
        msg="WARNING: WorkflowSQLite3DB.lock_workflow: Could not open workflow database file '#{@database_file}'.  The database is locked by SQLite."
        WorkflowMgr.stderr(msg,1)
        WorkflowMgr.log(msg)
        return false
      end  # begin
